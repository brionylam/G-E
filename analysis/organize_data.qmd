...
# merge 6 variables into one variable called "att", which means the  pro-environment attitude. these 6 variables are all ordinal variables, and there are 5 ordinal level from 0 points to 4 point, the greater the number, the more the respondent pro-environment. 
