...
# Assuming your dataset is named 'variables_of_interest'
...
scree(factor_analysis)

# Visualize Eigenvalues
fviz_eig(factor_analysis)

# Visualize Factor Loadings
fviz_pca_var(factor_analysis, col.var = "contrib", gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"), repel = TRUE)
