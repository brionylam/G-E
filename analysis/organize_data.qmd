...
ccam$party_x_ideo <- factor(case_when(
  ccam$income_category==1 ~ "Liberal Democrat",
  ccam$income_category==2 ~ "Moderate Democrat",
  ccam$income_category==3 ~ "Independent",
  ccam$income_category==4 ~ "Liberal Republican",
  ccam$income_category==5 ~ "Conservative Republican"),
  levels=c("Liberal Decmocrat","Moderate Democrat","Independent","Liberal Repbulican","Conservative Republican"))
